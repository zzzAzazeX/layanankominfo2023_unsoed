<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Fasilitas Internet / Wifi</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Fasilitas Internet / Wifi</li>
        </ol>
    </div>
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Fasilitas Internet / Wifi</h6>
                </div>
                <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush" id="dataTable">
                        ...
                        <?php if (empty($fasilitas_inter_wifi)) { ?>
                        <tr>
                            <td colspan="15">
                        ...
                        <tbody>
                            <?php $start = 0; ?>
                            <?php foreach($fasilitas_inter_wifi as $f) { ?>
                            <tr>
                                <td><?= ++$start ?></td>
                                <td><?= $f['nama'] ?></td>
                                <td><?= $f['jabatan'] ?></td>
    ...
    <!-- Modal delete -->
    <?php foreach ($fasilitas_inter_wifi as $f) { ?>
    <div class="modal fade" id="deleteModal<?= $f['id_fas_inter_wifi'] ?>" tabindex="-1" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('admin/delete_fasinter/'.$f['id_fas_inter_wifi'])?>"
    ...
    <!-- Modal Edit -->
    <?php foreach ($fasilitas_inter_wifi as $f) { ?>
    <div class="modal fade" id="editModal<?= $f['id_fas_inter_wifi'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <?php echo form_open('admin/edit_fasinter/'. $f['id_fas_inter_wifi']) ?>
